...
function readData() {
    ...
    for (let i = 0; i < datapro.length; i++) {
        ...
        <tr>
            ...
            <td><button class="icone" onclick="updataData(${i})" id="update"><i class="fa-solid fa-pen-to-square"></i></button></td>
            <td><button class="icone" onclick="dataDel(${i})"  id="delete"> <i class="fa-solid fa-trash-can"></i></button></td>
        </tr>
    `
    }
    ...
    if (datapro.length > 0) {
        btndelete.innerHTML = `
<button class="bb" onclick="deleteAll()"> مسح الكل ( ${datapro.length} )</button>
`
    } else {
        btndelete.innerHTML = '';
    }
